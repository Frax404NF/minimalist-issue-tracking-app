...
function IssuesTableSkeleton() {
  return (
    <div className="overflow-hidden rounded-lg border border-gray-200 dark:border-dark-border-default bg-white dark:bg-dark-high shadow-sm animate-pulse">
      <div className="grid grid-cols-12 gap-4 px-6 py-3 bg-gray-50 dark:bg-dark-elevated border-b border-gray-200 dark:border-dark-border-default">
        ...
        <div className="col-span-2 h-4 bg-gray-200 dark:bg-gray-700 rounded" />
        <div className="col-span-2 h-4 bg-gray-200 dark:bg-gray-700 rounded" />
        <div className="col-span-3 h-4 bg-gray-200 dark:bg-gray-700 rounded" />
      </div>
      {[1, 2, 3].map((i) => (
        <div key={i} className="grid grid-cols-12 gap-4 px-6 py-4 border-b border-gray-200 dark:border-dark-border-default">
          <div className="col-span-5 h-4 bg-gray-200 dark:bg-gray-700 rounded" />
          <div className="col-span-2 h-4 bg-gray-200 dark:bg-gray-700 rounded" />
          <div className="col-span-2 h-4 bg-gray-200 dark:bg-gray-700 rounded" />
          <div className="col-span-3 h-4 bg-gray-200 dark:bg-gray-700 rounded" />
